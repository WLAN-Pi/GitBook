...
## Navigating This Site <a id="navigating-this-site"></a>

In October 2020, after many months of hard work by the volunteer development team, the version 1 image of the WLAN Pi was superseded by [version 2](whats-new-in-version-2.md). Version 2 provides a more robust software architecture that will improve on many of the issues experienced in version 1 \(e.g. SD card re-burns for each software update\), Additionally, it provides a number of exciting new features.

It is anticipated that the version 1 image will still be in circulation for a while, so we have maintained all of the [version 1 image documentation]() here on the documentation site. You can find the version 1 documentation [here](). However, please note that we will not be maintaining these document going forwards - our development efforts will solely be around the new [version 2](whats-new-in-version-2.md) image.
