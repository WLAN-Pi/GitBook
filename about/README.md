...
You can find the official v2.0.0 announcement [here](v2.0.0-announcement.md). It details the main feature of the [new v2.0.0 release](v2.0.0-announcement.md).

## Version 2.0.0 Video & Slides <a id="version-200-video-slides"></a>

The WLAN Pi development team presented a collaborative video for the online CWNP 2020 WTF conference that details the main features and improvements of the version 2 image. [Links to the video and slide deck](version-2-video.md) are provided on this [page](version-2-video.md).
